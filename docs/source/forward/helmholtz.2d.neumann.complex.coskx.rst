Complex Helmholtz equation with Neumann boundary conditions over a 2D square complex domain
===========================================================================================
...
.. literalinclude:: ../../../examples/forward/Helmholtz_Neumann_2d_complex_coskx.py
  :language: python